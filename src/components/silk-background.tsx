...
const COLORS = [
  0.008, 0.004, 0.039, 0.016, 0.02, 0.18, 0.239, 0.173, 0.553, 0.569, 0.42, 0.749,
...
export function SilkBackground({
  ...
  useEffect(() => {
    ...
    gl.uniform3fv(u("u_colors[0]"), new Float32Array(COLORS));
    gl.uniform4f(u("u_shape"), 1.26, 0.28, 0.5, 0.0);
    gl.uniform4f(u("u_surface"), 2.4, 1.11, 0.0, 1.0);
    gl.uniform4f(u("u_finish"), 0.0, 0.0, 0.0, 0.05);
    gl.uniform4f(u("u_transform"), 1581.0, 0.0, 0.0, 0.0);
    ...
    const render = (now: number) => {
      ...
      gl.uniform4f(sceneLoc, width, height, elapsed * 0.76, 4.0);
