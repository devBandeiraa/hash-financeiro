...
export default defineMcp({
  name: "finpessoal-mcp-server",
  title: "FinPessoal MCP Server",
  version: "1.0.0",
  instructions:
    "Servidor MCP do FinPessoal para gestão financeira pessoal. Permite consultar contas, saldo, transações e resumos mensais, além de criar transações manuais, gerenciar regras e recategorizar lançamentos com isolamento de dados por usuário via Row Level Security (RLS).",
